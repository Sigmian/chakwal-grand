      ...
      <div className="max-w-lg mx-auto text-center py-8 animate-fade-in">
        ...
        <div className="card-luxury rounded-2xl p-6 text-left space-y-4 mb-8">
          ...
          {[
            ...
            ["Total",     formatPKR(Number(selectedRoom?.pricePerNight ?? 0) * nights)],
            ["Payment",   "Cash on arrival (advance booking preferred)"],
          ].map(([k, v]) => (
        ...
        <div className="flex gap-3 justify-center">
          <a href={`https://wa.me/923347742767?text=Booking Reference: ${bookingRef} — Please confirm my booking.`}
            ...
            className="flex items-center gap-2 px-5 py-2.5 bg-[#25D366]/15 border border-[#25D366]/30 text-[#25D366] text-sm font-semibold rounded-xl hover:bg-[#25D366]/25 transition-colors">
