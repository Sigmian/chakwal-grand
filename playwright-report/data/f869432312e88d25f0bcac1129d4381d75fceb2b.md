...
- Name: booking-flow.spec.ts >> my-booking accepts a reference and shows result or error
- Location: e2e\booking-flow.spec.ts:113:5
...
Call log:
  - waiting for getByPlaceholder(/booking reference|BK-/i)
