...
- Name: rooms.spec.ts >> clicking room card navigates to room detail
- Location: e2e\rooms.spec.ts:23:5
...
Expected pattern: /\/rooms\//
Received string:  "http://localhost:3000/book"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    13 × unexpected value "http://localhost:3000/book"
