...
const SEASONS = [
  { icon: "â„ï¸", season: "October – March", rating: "★★★★★ Best Season", color: "border-blue-500/30 bg-blue-500/5", temp: "5–22°C", desc: "Cool and perfect for all outdoor activities. Ideal for visiting Katas Raj, hiking in the Salt Range, and exploring Kallar Kahar. This is peak tourist season — book accommodation in advance for weekends." },
            ...
            <section id="transport">
              ...
              <div className="mt-4 card-luxury rounded-2xl p-5">
                ...
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2"><span className="text-gold-400">â†’</span>Rickshaws (tuk-tuks) are the most common local transport for short distances — fare PKR 50–150.</li>
                  <li className="flex items-start gap-2"><span className="text-gold-400">â†’</span>For day trips to Katas Raj/Kallar Kahar, hire a local taxi from Chakwal city — negotiate PKR 1,500–2,500 for a full-day trip.</li>
                  <li className="flex items-start gap-2"><span className="text-gold-400">â†’</span>Ride-hailing apps (InDrive) operate in Chakwal city — cheaper than negotiating with local taxis.</li>
                  <li className="flex items-start gap-2"><span className="text-gold-400">â†’</span>Renting your own car from Rawalpindi is recommended for maximum flexibility — gives you freedom to explore the Salt Range at your own pace.</li>
                </ul>
              </div>
            </section>
            ...
            <section id="tips">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {[
                  ...
                  { icon: "â›½", title: "Fuel in City", tip: "Fill your petrol in Chakwal city before heading to Katas Raj or Salt Range — limited fuel stations on these routes." },
