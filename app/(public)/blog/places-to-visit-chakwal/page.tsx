...
const PLACES = [
  {
    ...
    linkLabel: "Full Katas Raj visitor guide →",
  },
  {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="card-luxury rounded-2xl p-8 text-center border border-gold-500/20 mt-10">
          ...
          <p className="text-muted-foreground text-sm mb-6 max-w-lg mx-auto">
            Stay at Chakwal Grand Guest House — the most trusted accommodation in Chakwal district. AC rooms, family suites, free WiFi from PKR 2,000/night. Pay cash on arrival, no advance payment required.
          </p>
