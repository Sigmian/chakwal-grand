...
const FAQ_SCHEMA = {
  ...
  "mainEntity": [
    ...
    { "@type": "Question", "name": "Is Chakwal worth visiting?", "acceptedAnswer": { "@type": "Answer", "text": "Absolutely — Chakwal is one of Punjab's most underrated destinations. It has a 5,000-year-old temple complex (Katas Raj), a beautiful natural lake (Kallar Kahar), ancient forts, scenic Salt Range hills, and a cooler climate than nearby cities. It is an excellent 2-3 day trip from Rawalpindi or Lahore." } },
    { "@type": "Question", "name": "How far is Chakwal from Rawalpindi?", "acceptedAnswer": { "@type": "Answer", "text": "Chakwal city is approximately 80–90 km from Rawalpindi/Islamabad. The drive takes about 1.5 hours via the M-2 motorway and Chakwal road." } },
    { "@type": "Question", "name": "Is Kallar Kahar Lake in Chakwal?", "acceptedAnswer": { "@type": "Answer", "text": "Yes — Kallar Kahar Lake is located in Chakwal district, approximately 45 km from Chakwal city. It is a natural saline lake surrounded by the Salt Range hills and is a popular tourist spot." } },
  ],
};
...
const PLACES = [
  ...
  },
  {
    ...
    desc: "Kallar Kahar is a stunning natural saline lake nestled in the Salt Range hills, covering approximately 9–10 kmÂ². Famous for its changing colours with the seasons — deep blue in winter, emerald green in spring — the lake is a paradise for nature lovers and photographers. The lake is surrounded by green parks, boating facilities, and the Kallar Kahar Wildlife Park where you can spot peacocks and migratory birds. A historical Babur&apos;s Throne (Takht-e-Babri) is located nearby.",
      ...
      <div className="relative h-[50vh] min-h-[350px] w-full overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-10 max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl sm:text-5xl font-bold font-serif text-foreground mt-3 mb-3 leading-tight">
            Top 10 Places to Visit in Chakwal<br className="hidden sm:block" /> — Complete Tourist Guide 2025
          </h1>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-invert max-w-none mb-10">
          ...
          <p className="text-muted-foreground leading-relaxed mt-3">
            Whether you are a history enthusiast, nature lover, photographer, or just looking for a peaceful weekend escape from Rawalpindi or Lahore — Chakwal has something extraordinary to offer. Here are the <strong className="text-foreground">top places to visit in Chakwal</strong> in 2025.
          </p>
        </div>
