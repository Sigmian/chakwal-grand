            ...
            <section id="how-to-reach">
              ...
              <div className="mt-4 card-luxury rounded-2xl p-5">
                ...
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2"><span className="text-gold-400 flex-shrink-0">â†’</span>From Rawalpindi/Islamabad: Take a bus or wagon to Chakwal (PKR 200–300). From Chakwal, hire a rickshaw or local taxi to Katas Raj (PKR 500–800 one way).</li>
                  ...
                  <li className="flex items-start gap-2"><span className="text-gold-400 flex-shrink-0">â†’</span>There is no direct public bus to Katas Raj — local transport (chingchi rickshaw or Suzuki van) is the only option from Chakwal city.</li>
                </ul>
              </div>
            </section>
